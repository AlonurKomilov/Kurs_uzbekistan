...
start.welcome = Hello! I'm KUBot, a currency exchange rates bot. Please choose one of the buttons below:
start-command = /start - Start the bot
help-command = /help - Get help
rates-command = /rates - Show currency rates
...
lang.saved = Language changed successfully!
lang.uz-cy = UZ/Kirill
lang.ru = RU
lang.en = EN
